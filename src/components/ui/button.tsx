  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent text-sm font-semibold whitespace-nowrap transition-colors outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/40 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-orange text-warm-white hover:bg-orange-hover focus-visible:ring-orange/40",
        outline:
          "border-border bg-warm-white text-deep-navy hover:bg-secondary",
        secondary:
          "bg-secondary text-deep-navy hover:bg-warm-beige/80",
